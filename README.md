...
[🔗 View Website](https://clorostica.github.io/Eggtimer/)
...
2. Click on **"Let's Start"** to begin selecting your preferred egg boiling time.
3. (Assumes `select.html` contains the timing logic.)
